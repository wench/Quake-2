...
static void WGL_GetExtensions(void)
{
	qwglGetExtensionsStringARB = (void*) qwglGetProcAddress("wglGetExtensionsStringARB");
	...
	{
		qwglGetPixelFormatAttribivARB = (void*) qwglGetProcAddress( "wglGetPixelFormatAttribivARB" );
		qwglGetPixelFormatAttribfvARB = (void*) qwglGetProcAddress( "wglGetPixelFormatAttribfvARB" );
		qwglChoosePixelFormatARB = (void*) qwglGetProcAddress( "wglChoosePixelFormatARB" );
