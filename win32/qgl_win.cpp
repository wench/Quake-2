...
qboolean QGL_Init( const char *dllname )
{
	...
	qglGenLists                  = 	dllGenLists                   = (decltype(dllGenLists)) GPA( "glGenLists" );
	...
	qglGetError                  = 	dllGetError                   = (decltype(dllGetError)) GPA( "glGetError" );
	...
	qglGetTexLevelParameterfv    = 	dllGetTexLevelParameterfv     = (decltype(dllGetTexLevelParameterfv)) GPA( "glGetLevelParameterfv" );
	qglGetTexLevelParameteriv    = 	dllGetTexLevelParameteriv     = (decltype(dllGetTexLevelParameteriv)) GPA( "glGetLevelParameteriv" );
