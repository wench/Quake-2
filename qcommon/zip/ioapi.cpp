...
voidpf ZCALLBACK fopen_file_func_opaque_ro(voidpf opaque, const char* filename, int mode)
{
	// readonly!
...
void qfill_fopen_filefunc(zlib_filefunc_def* pzlib_filefunc_def, FILE*file)
{
	pzlib_filefunc_def->zopen_file = fopen_file_func_opaque_ro;
	pzlib_filefunc_def->zread_file = fread_file_func;
	pzlib_filefunc_def->zwrite_file = fwrite_file_func;
	pzlib_filefunc_def->ztell_file = ftell_file_func;
	pzlib_filefunc_def->zseek_file = fseek_file_func;
