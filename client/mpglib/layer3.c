 ...
 */
#ifdef MPEG1 
static void III_get_side_info_1( III_sideinfo *si,int stereo,
 ...
 */
static void III_get_side_info_2( III_sideinfo *si,int stereo,
 int ms_stereo,long sfreq,int single)
{
   int ch;
   int powdiff = (single == 3) ? 4 : 0;
   ...
   gr_info_s *gr_info,int sfreq,int ms_stereo,int lsf)
{
      real (*xr)[SBLIMIT*SSLIMIT] = (real (*)[SBLIMIT*SSLIMIT] ) xr_buf;
       bandInfoStruct *bi = &bandInfo[sfreq];
      real *tab1,*tab2;
 ...
 * main layer3 handler
 */
int do_layer3( frame *fr,unsigned char *pcm_sample,int *pcm_point)
{
  int gr, ch, ss,clip=0;
